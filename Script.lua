...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      Key = {"var1340_upvw"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
local Button = Tab:CreateButton({
   Name = "Hub",
   Callback = function()
   loadstring(game:HttpGet('https://raw.githubusercontent.com/t1hub2/Brub-OLD-/refs/heads/main/.lua'))()
   end,
})
